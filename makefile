...
TARGET_NAME      := AE442_AU
BOARD_ID         := TEENSY40

MCU              := imxrt1062

LIBS_SHARED_BASE := C:\Users\Joshu\OneDrive\Documents\Arduino\libraries
LIBS_SHARED      := 

LIBS_LOCAL_BASE  := lib
LIBS_LOCAL       := SparkFun_MPL3115A2_Altitude_and_Pressure_Sensor_Breakout SparkFun_MPU-9250_9_DOF_IMU_Breakout SPI Wire 
